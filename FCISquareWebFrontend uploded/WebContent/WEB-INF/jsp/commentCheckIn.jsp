	        ...
	        <body >
	            ...
	            <div id="container">
	                <form action="doCommentcheckin" method="post">
	                    <label for="CheckinID">CheckIn ID to comment:</label>
						<input type="text" name = "checkinID" />
						<label for="CommentText">Comment body:</label>
						<input type="text" name = "CommentText" />
						<input type="hidden" name=UserCommentID value=<%=session.getAttribute("id")%> >	                    
 	                    <div id="lower">
